...
export default class BaiTapLayoutWithMap extends Component {
    dataPhim = [
        {
            "maPhim": 1321,
            "tenPhim": "Ted2",
    ...
    renderPhim = () => {
        return this.dataPhim.map((item, index) => {
            return <div key={index} className="col-4 mt-5">
                <div className="card text-left">
                    <div>
                        <img className="card-img-top" style={{ width: "200px", height: "200px", }} src={item.hinhAnh} alt="" />
                    </div>
                    <div className="card-body">
                        <h4 style={{ height: "50px" }} className="card-title">{item.tenPhim}</h4>
                        <p style={{ height: "80px" }} className="card-text">
